      ...
      return (
        ...
        <div className="Container py-5">
          ...
          <div className="ImgContainer">
            <img src={"../"+foundProduct.img} alt={foundProduct.title} className="Img" />
          </div>
          <div className="InfoContainer">
            ...
            <div className="BtnContainer">
              ...
              <button
                    disabled={foundProduct.inCart ? true : false}
                    onClick={() => {
                      
                    }}
                   
                  >
                    {foundProduct.inCart ? <span>in Cart</span> : <span>ADD To CART</span>}
                  </button>
